...
class Cholec80():
    def __init__(self, hparams):
        ...
        # For EndoViT: the input doesn't have to be 25FPS
        # -> both features_per_second and features_subsampling will be fixed at 1FPS
        hparams.factor_sampling = (int(self.features_per_seconds / hparams.features_subsampling))
        print(
            f"Subsampling features: {self.features_per_seconds}features_ps --> {hparams.features_subsampling}features_ps (factor: {hparams.factor_sampling})"
        )
